...
up-dev:
	# ./scripts/chmod-666-to-log-files.sh
	docker-compose --env-file ./env/.env.development -f docker-compose.dev.yml up $(op) 

down-dev:
	docker-compose --env-file ./env/.env.development -f docker-compose.dev.yml down $(op) 
